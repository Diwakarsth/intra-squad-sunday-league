...
3. Upload/commit **all files inside this v1.1.2 ZIP** to the GitHub repository root, replacing the previous release files.
...
Installed PWAs use cache `issl-v1.1.2` and the version checker will refresh stale app files.
